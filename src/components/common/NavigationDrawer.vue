...
.drawer-link-icon{flex:0 0 auto;width:22px;height:22px}.drawer-theme{display:none;align-self:flex-end;width:42px;height:42px;padding:0;place-items:center;border:1px solid var(--border);border-radius:50%;background:var(--surface-muted);color:var(--primary);font:inherit;font-size:1.35rem;cursor:pointer;transition:background .2s ease,color .2s ease}.drawer-theme:hover{background:var(--primary);color:var(--on-primary)}
...
@media (min-width:769px){.drawer-trigger{display:none}.navigation-drawer{top:0;width:var(--desktop-drawer-width);padding:0 1rem 1.25rem;border-right:1px solid rgba(85,34,0,.16);box-shadow:none;overflow-y:auto;transform:translateX(0);transition:width .26s ease,padding .26s ease}.drawer-header{height:calc(68px + env(safe-area-inset-top));padding:env(safe-area-inset-top) 0 0}.drawer-theme{display:grid}.navigation-drawer.is-compact{width:var(--desktop-drawer-collapsed-width);padding-right:.65rem;padding-left:.65rem}.navigation-drawer.is-compact .drawer-header{justify-content:center}.navigation-drawer.is-compact .drawer-brand,.navigation-drawer.is-compact .drawer-link-label,.navigation-drawer.is-compact .drawer-language,.navigation-drawer.is-compact .drawer-footer{display:none}.navigation-drawer.is-compact .drawer-links a{justify-content:center;padding:.8rem 0}.navigation-drawer.is-compact .drawer-theme{align-self:center}.navigation-drawer.is-compact .drawer-close{display:grid;place-items:center}}
</style>
