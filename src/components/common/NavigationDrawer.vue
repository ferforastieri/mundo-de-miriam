...
@media (min-width:769px){.navigation-drawer{top:calc(68px + env(safe-area-inset-top));width:var(--desktop-drawer-width);padding-top:1.25rem;border-right:1px solid rgba(85,34,0,.16);box-shadow:none;overflow-y:auto}}
</style>
