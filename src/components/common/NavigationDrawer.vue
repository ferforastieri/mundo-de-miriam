...
.drawer-link-icon{flex:0 0 auto;width:22px;height:22px}

@media (max-width:768px){.drawer-trigger{z-index:10006}.drawer-backdrop{z-index:10007}.navigation-drawer{z-index:10008}}
@media (min-width:769px){.drawer-trigger{display:none}.navigation-drawer{top:0;width:var(--desktop-drawer-width);padding:0 1rem 1.25rem;border-right:1px solid rgba(85,34,0,.16);box-shadow:none;overflow-y:auto;transform:translateX(0);transition:width .26s ease,padding .26s ease}.drawer-header{height:calc(68px + env(safe-area-inset-top));padding:env(safe-area-inset-top) 0 0}.navigation-drawer.is-compact{width:var(--desktop-drawer-collapsed-width);padding-right:.65rem;padding-left:.65rem}.navigation-drawer.is-compact .drawer-header{justify-content:center}.navigation-drawer.is-compact .drawer-brand,.navigation-drawer.is-compact .drawer-link-label,.navigation-drawer.is-compact .drawer-language,.navigation-drawer.is-compact .drawer-footer{display:none}.navigation-drawer.is-compact .drawer-links a{justify-content:center;padding:.8rem 0}.navigation-drawer.is-compact .drawer-close{display:grid;place-items:center}}
</style>
